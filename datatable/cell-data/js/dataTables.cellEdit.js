...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        ...
        case "datepicker-confirm":
			...
			input.html = "<input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'  onchange='$(this).updateEditableCell(this);'  value='" + oldValue + "'></input> ";
        ...
        case "text-confirm": // text input w/ confirm
			...
			input.html = "<input id='ejbeatycelledit' class='" + inputCss + "' value='"+oldValue+"' onfocusout='$(this).updateEditableCell(this)'></input>";
